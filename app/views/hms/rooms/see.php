...
<section class="index">
    <div class="content-box column">
        <h2 class="home-see-message"><i class="fas fa-igloo"></i> &nbsp; Room Types List</h2>
        <!-- Searchbox -->
            ...
            <tbody>
                <?php foreach ($data['posts'] as $post) : ?>
                    <tr>
                        ...
                        <td><?php echo $post->roomSize . ' m²'; ?></td>
                        <td><?php echo $post->roomTotal_Of_Type; ?></td>
                        <td><?php echo '$ ' . $post->roomPrice; ?></td>
                        <td><a href="<?php echo URLROOT . '/hms/roomDetail/' . $post->id; ?>" style="color: #0e4892"><i class="far fa-eye"></i></a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        ...
        <div class="pagination">
            ...
            for ($page = 1; $page <= $numberOfPages; $page++) {
                echo "<a class='pageee' href='http://localhost/juno/hms/seeRooms?page=" . $page . "'>" . $page . "</a> ";
            }
            ?>
        </div>
    </div>
</section>
<!-- End of See Rooms Type Page -->
